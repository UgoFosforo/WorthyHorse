package me.architetto.worthyhorses.cmd;

import me.architetto.worthyhorses.cmd.admin.PowerupCmd;
import me.architetto.worthyhorses.cmd.admin.TameCmd;
import me.architetto.worthyhorses.cmd.admin.TestCmd;
import me.architetto.worthyhorses.cmd.user.EggifyCmd;
import me.architetto.worthyhorses.cmd.user.StatsCmd;
import me.architetto.worthyhorses.util.NameUtil;
...
public class CommandManager implements TabExecutor{
    ...
    public CommandManager() {
        subcommands.add(new EggifyCmd());
        subcommands.add(new TameCmd());
        subcommands.add(new StatsCmd());
        subcommands.add(new PowerupCmd());
        //subcommands.add(new TestCmd());
